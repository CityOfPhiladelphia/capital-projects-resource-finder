export default{
  "language": "Inglés",
  "app": {
    "title": "Buscador de proyectos de capital",
    "subtitle": "Encuentre inversiones en curso en instalaciones de propiedad municipal",
    ...
    "searchPlaceholders": {
      "all": "Buscar por dirección, código postal o palabra clave"
    },
    ...
    "viewMap": "Ver mapa",
    "viewList": "Ver lista",
    "viewAccessible": "Ver la lista accesible de ubicaciones del sitio"
  },
  "introPage": {
    "section1Title": "Encuentre servicios y asistencia cerca de usted",
    "h3_1": "Acerca del Programa de Capital y nuestros proyectos",
    "p1": "La ciudad de Filadelfia usa fondos de capital para mejorar las instalaciones y servicios municipales. Estos proyectos pueden incluir inversiones en:",
    "ul1": {
      "li": "Mejoras a edificios e instalaciones de propiedad municipal",
      "li2": "Tecnología urbana y redes de comunicaciones",
      "li3": "Vehículos municipales especializados",
    ...
    "ul2": {
      ...
      "li2": "Centros de salud",
      "li3": "Bibliotecas",
      "li4": "Comisarías de bomberos y policía",
      "li5": "Otras instalaciones e infraestructuras de propiedad municipal"
    },
    "p4": "También puede encontrar proyectos finalizados y archivados recientemente (completados en los últimos seis meses).",
    "p5": "Los proyectos se organizan por instalación. Algunas instalaciones pueden tener varios proyectos activos a la vez.",
    "h3_3": "Retroalimentación",
    "p6": "Actualizamos la información del proyecto trimestralmente. Si algo va mal, puedes hacérnoslo saber a través de nuestro formulario de <a target='_blank' href='https://www.phila.gov/feedback/'>comentarios.</a>"
  },
  "status": {
    "category": "Estado",
